...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('user.store')}}">
        ...
        <input id="inputTitle" type="text" name="full_name" placeholder="Enter full_name"  value="{{old('full_name')}}" class="form-control">
        @error('full_name')
        ...
        <input id="inputtext" type="text" name="phone" placeholder="Enter phone"  value="{{old('phone')}}" class="form-control">
        @error('phone')
        <span class="text-danger">{{$message}}</span>
        @enderror
      </div>
      ...
      <input id="inputnumber" type="text" name="address" placeholder="Enter address"  value="{{old('address')}}" class="form-control">
      @error('address')
      <span class="text-danger">{{$message}}</span>
      @enderror
    </div>

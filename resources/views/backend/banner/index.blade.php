            ...
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        {{-- <input type="checkbox" data-toggle="switchbutton" checked data-onllabel="Ready" data-offofflabel="Not Ready" data-onstyle="success" data-offstyle="danger" data-size="sm"> --}}

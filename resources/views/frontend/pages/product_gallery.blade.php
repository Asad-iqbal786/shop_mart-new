                            ...
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a title="Add to cart" href="" data-quantity="1" data-product-id="{{$item->id}}" class="btn add-to-cart" id="add-to-cart{{$item->id}}">Add to cart asadsd</a>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).on('click','.add-to-cart',function(e){
        ...
        $.ajax({
            ...
            beforeSend:function(){
                $('#add-to-cart'+product_id).html('<i class="fa fa-spiner fa-spin"<i> loading....');
            },
            complete:function(){
